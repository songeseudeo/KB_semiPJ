      ...
      <div className="loan-body">
        ...
        <div className="custom-step-box">
          ...
          <div className="loan-form-group">
            <label className="loan-label">📍 지역 — 반드시 구·시 단위로 입력</label>
            <input className="loan-input" placeholder="예: 강남구 / 수원시 / 해운대구 / 마포구"
              value={region} onChange={e => { setRegion(e.target.value); setStep(1); setPriceData(null); setChecklist(null); }} />
            <div style={{ fontSize: 11, color: '#8A96B0', marginTop: 6 }}>
              ⚠️ 동(洞) 단위는 지원 안 돼요. 구·시 단위로만 입력하세요.<br/>
              예) 하대원동 ❌ → 성남시 ✅ &nbsp;|&nbsp; 역삼동 ❌ → 강남구 ✅
            </div>
          </div>
          <div className="loan-form-group">
